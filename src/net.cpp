...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "urichie " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"128.199.241.214", "128.199.241.214"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. urichie is probably already running."), addrBind.ToString().c_str());
        else
